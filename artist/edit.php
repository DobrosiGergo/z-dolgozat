        ...
        <div class="card  card-body" style="width: 50rem; ">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" name="author_name" class="form-control w-50 align-items-center" value="<?=$artistItem->name?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="country_name" value="<?= $artistItem->city_name?>" class="form-control w-50 align-items-center" id="formGroupExampleInput" required>
                </div>
                <div class="form-group">
