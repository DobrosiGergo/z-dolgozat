...
$music = $musicNameSpace->getItemById($_GET['id']);
if(!$music){
echo "Nincsen ilyen Alkotás feltöltve";
die();
}
if(isset($_POST['upload'])){
$updateSheet = new APP\Models\UploadedMusic;
$updateSheet->update($_POST);
}
    ...
    <div style="margin:  0 auto; width: 100%; max-width:500px; margin-left:100px; padding-top:50px;">
        <div class="card  card-body" style="width: 50rem; ">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="formGroupExampleInput1">Leírás</label>
                  <textarea name="description"  cols="30" rows="10" id="FormGroupExampleInput1"><?=$music->embed?></textarea>
                </div>
